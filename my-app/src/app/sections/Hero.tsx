...
export const Hero = () => {
  ...
  return (
    <div className="bg-white text-gray-900 relative overflow-hidden py-28 mt-10">
      <motion.div 
      ...
      <div className="container mx-auto px-4 relative">
        <motion.div 
          ...
          transition={{ duration: 0.5 }}
        >
          <h1 className="text-3xl md:text-6xl font-bold tracking-tighter text-center text-emerald-800">
            {isMobile ? (
              <>
                Une expérience<br />
        ...
        >
          <p className="text-center text-sm md:text-[1.2rem] leading-6 max-w-md text-gray-600">
