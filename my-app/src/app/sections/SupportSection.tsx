    ...
    <section className="py-12 md:py-20">
      <div className="container mx-auto px-4 md:px-8 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        <div className="lg:w-1/2 w-full">
          <div className="relative h-[250px] sm:h-[300px] md:h-[400px] w-full overflow-hidden rounded-xl">
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-emerald-600/10 z-10"></div>
            <Image
              src={support}
              alt="Support"
              layout="fill"
